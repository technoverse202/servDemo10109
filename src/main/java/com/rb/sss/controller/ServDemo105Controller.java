...
import com.rb.sss.service.ServDemo105Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo105Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo105Controller.class);
	@Inject
	ServDemo105Service service;
